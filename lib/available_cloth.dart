        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Available Fashion (" + getClothList().length.toString() + ")",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 36,
              ...
              Expanded(
                child: GridView.count(
                  ...
                  crossAxisSpacing: 15,
                  mainAxisSpacing: 15,
                  children: getClothList().map((item) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => BookCloth(cloth: item)),
                        );
                      },
                      child: buildCloth(item, null)
                    );
                  }).toList(),
                ),
              ),
